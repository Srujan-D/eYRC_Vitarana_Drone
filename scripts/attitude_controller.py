...
class Edrone:
    ...
    def __init__(self):
        ...
        self.yaw_pub = rospy.Publisher("/yaw_err", Float32, queue_size=1)
        ...
        rospy.Subscriber("/zero", Float32, self.cb)
    ...
    def pid(self):
        ...
        self.error[0] = self.setpoint_euler[0] - (
            self.drone_orientation_euler[0]  #* (180 / value_of_pi)
        )
        self.error[1] = self.setpoint_euler[1] - (
            self.drone_orientation_euler[1] # * (180 / value_of_pi)
        )
        self.error[2] = self.setpoint_euler[2] - (
            self.drone_orientation_euler[2] # * (180 / value_of_pi)
        )

        self.error_sum[0] = self.error_sum[0] + self.error[0]*self.sample_time
        ...
        # print('self.out_pitch',self.out_pitch)
        # print('self.out_roll',self.out_roll)
        # print('self.out_yaw',self.out_yaw)
